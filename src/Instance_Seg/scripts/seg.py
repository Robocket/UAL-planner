...
try:
    ...
    raise ImportError(
        ...
        "-r src/Instance_Seg/requirements.txt"
    ) from exc
...
class YoloSegmentationTracker(Node):
    def __init__(self):
        ...
        self.declare_parameter('tracking_persist', True)
        self.declare_parameter('inference_verbose', False)
        ...
        self.tracking_persist = self.get_parameter('tracking_persist').value
        self.inference_verbose = self.get_parameter('inference_verbose').value
        ...
        self.annotated_pub = self.create_publisher(Image, annotated_topic, qos_depth)
    ...
    def image_callback(self, msg):
        try:
            ...
            results = self.model.track(
                ...
                verbose=self.inference_verbose,
            )
